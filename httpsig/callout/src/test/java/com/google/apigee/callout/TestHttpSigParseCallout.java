...
public class TestHttpSigParseCallout extends CalloutTestBase {
  ...
  public void test2_GoodSig_Property() {
    ...
    properties.put(
        "fullsignature",
        "keyId=\"test2_GoodSig_Property\",algorithm=\"hmac-sha256\",headers=\"(request-target) date\",signature=\"udvCIHZAafyK+szbOI/KkLxeIihexHpHpvMrwbeoErI=\"");
  ...
  public void test4_BadHeader_Algorithm() {
    ...
    properties.put(
        "fullsignature",
        "keyId=\"test4_BadHeader_Algorithm\",algorithm=\"icecream\",headers=\"(request-target) date\",signature=\"udvCIHZAafyK+szbOI/KkLxeIihexHpHpvMrwbeoErI=\"");
    properties.put("algorithm", "hmac-sha256");
    properties.put("headers", "date");
    properties.put("maxtimeskew", "-1");
    ...
    Assert.assertEquals(result, ExecutionResult.ABORT);
    Assert.assertTrue(
        error.startsWith("the signature is malformed: unsupported algorithm: icecream"));
  }
  ...
  public void test5_RSA_GoodHeader() {
    ...
    properties.put(
        "fullsignature",
        "keyId=\"test5_RSA_GoodHeader\",algorithm=\"rsa-sha256\",headers=\"(request-target) nonce date\",signature=\"udvCIHZAafyK+szbOI/KkLxeIihexHpHpvMrwbeoErI=\"");
    properties.put("algorithm", "hmac-sha256");
    properties.put("headers", "date");
    properties.put("maxtimeskew", "-1");
